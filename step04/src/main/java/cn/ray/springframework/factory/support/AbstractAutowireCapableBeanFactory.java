...
import cn.ray.springframework.PropertyValue;
import cn.ray.springframework.PropertyValues;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory{
    ...
    protected Object createBean(String beanName, BeanDefinition beanDefinition,Object[] args) throws BeansException {
        ...
        try {
            ...
            if(beanDefinition.getPropertyValues()!=null) applyPropertyValues(beanName,bean,beanDefinition);
        } catch (Exception e) {

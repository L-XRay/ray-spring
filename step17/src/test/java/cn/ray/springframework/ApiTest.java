...
import cn.ray.springframework.converter.StringToIntegerConverter;
import cn.ray.springframework.core.convert.converter.Converter;
import cn.ray.springframework.core.convert.support.StringToNumberConverterFactory;
...
public class ApiTest {
    ...
    public void test_StringToIntegerConverter() {
        ...
        System.out.println("测试结果：" + num.getClass().getTypeName());
    }
